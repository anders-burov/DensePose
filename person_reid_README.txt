...
$ python tools/infer_for_reid.py --cfg configs/DensePose_ResNet101_FPN_s1x-e2e.yaml --output-dir ./person_reid_data --image-ext jpg --wts /data/DensePose_ResNet101_FPN_s1x-e2e.pkl /data/MSMT17_V1
